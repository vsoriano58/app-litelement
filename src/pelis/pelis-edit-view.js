...
import { getPelis, getPeliId, resetPeliId, peliNotFound, peliEdit } from '../redux/actions/pelis-actions';
...
class PelisEditView  extends connect(store)(PageViewElement) {
  ...
  get peliFormTemplate() {
    return html`
      ...
      <dile-rounded-button @click="${this.doEdit}">Aeptar</dile-rounded-button>
